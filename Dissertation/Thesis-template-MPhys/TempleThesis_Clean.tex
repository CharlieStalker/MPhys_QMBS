...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\theAuthor}{Charlie Stalker}
\newcommand{\authorEmail}{py19cjs@leeds.ac.uk}
\newcommand{\myTitle}{Quantum Many-Body Scars:\\ Quantum Fisher Information in the Spin $\frac{1}{2}$ Heisenberg XY model}
\newcommand{\supervisor}{Dr. Z. Papi\'c}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
